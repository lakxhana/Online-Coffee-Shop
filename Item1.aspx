<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Item1.aspx.cs" Inherits="Mini_Project_2A.Homepage" %>
    ...
    <table class="w-100">
        <tr>
            ...
            <td rowspan="9" class="auto-style17">
                <asp:Image ID="product_image" runat="server" Height="450px" ImageUrl="~/Pictures/product1.png" Width="376px" />
            </td>
        ...
        <tr>
            ...
            <td class="auto-style10"><strong>
                <asp:Label ID="prodName" runat="server" Font-Size="20pt" Text="Signature Blend Roast Coffee"></asp:Label>
                </strong></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
...
&nbsp;
                <asp:Label ID="prodPrice" runat="server" Font-Bold="True" Font-Size="13pt" ForeColor="#996633" Text="50"></asp:Label>
            </td>
            <td class="auto-style11"></td>
            <td class="auto-style11"></td>
        </tr>
        ...
        <tr>
            ...
            <td class="auto-style10">
                ...
                <asp:TextBox ID="TextBoxQty" runat="server" Height="22px" Width="37px" AutoPostBack="True" ReadOnly="True">1</asp:TextBox>
