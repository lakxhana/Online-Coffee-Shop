<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Item4.aspx.cs" Inherits="Mini_Project_2A.Item4" %>
     ...
     <table class="w-100">
        <tr>
            ...
            <td rowspan="9" class="auto-style17">
                <asp:Image ID="product_image" runat="server" Height="450px" ImageUrl="~/Pictures/product4.png" Width="376px" />
            </td>
        ...
        <tr>
            ...
            <td class="auto-style10"><strong>
                <asp:Label ID="prodName" runat="server" Font-Size="20pt" Text="Premium Roast Coffee"></asp:Label>
                </strong></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
...
&nbsp;
                <asp:Label ID="prodPrice" runat="server" Font-Bold="True" Font-Size="13pt" ForeColor="#996633" Text="55"></asp:Label>
            </td>
            <td class="auto-style11"></td>
            <td class="auto-style11"></td>
        </tr>
        ...
        <tr>
            ...
            <td class="auto-style10">
                <asp:Button ID="btn_minus" runat="server" Text="-" OnClick="btn_minus_Click" style="height: 29px" />
