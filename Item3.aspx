<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Item3.aspx.cs" Inherits="Mini_Project_2A.Item3" %>
     ...
     <table class="w-100">
        <tr>
            ...
            <td rowspan="9" class="auto-style17">
                <asp:Image ID="product_image" runat="server" Height="450px" ImageUrl="~/Pictures/product3.png" Width="376px" />
            </td>
        ...
        <tr>
            ...
            <td class="auto-style10"><strong>
                <asp:Label ID="prodName" runat="server" Font-Size="20pt" Text="Medium Roast Ground Coffee"></asp:Label>
                </strong></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
...
&nbsp;
                <asp:Label ID="prodPrice" runat="server" Font-Bold="True" Font-Size="13pt" ForeColor="#996633" Text="45"></asp:Label>
            </td>
            <td class="auto-style11"></td>
            <td class="auto-style11"></td>
        </tr>
